...
(function e(t, n, r) {
    function s(o, u) {
        ...
        var Website = function Website(name, url) {
        ...
        var WebsiteBlackList = require('./websiteBlackList');
        var PastDaysList = require('./pastDaysList');
        var WebsiteList = require('./websiteList');

        var AppLoadService = function () {
            function AppLoadService() {
                _classCallCheck(this, AppLoadService);

                return this.initializeApp();
            }

            _createClass(AppLoadService, [{
                key: "initializeApp",
                ...
                key: "initializeBlackList",
                value: function initializeBlackList() {
                    var instance = new WebsiteBlackList("blacklist", ["newtab", "chrome://", "localhost", "chrome-extension://", "about:blank", "file://"]);

                    return instance;
                }
            }, {
                key: "initializeWebsiteList",
                value: function initializeWebsiteList() {
                    var instance = new WebsiteList("websiteList", []);
                    return instance;
                }
            }, {
                key: "initializePastDaysList",
                value: function initializePastDaysList() {
                    var instance = new PastDaysList("pastDays", []);
                    return instance;
                }
            }]);
        ...
        var appLoadService = new AppLoadService();

        var WebsiteBlackList = appLoadService.WebsiteBlackList;
        var PastDaysList = appLoadService.PastDaysList;
        var WebsiteList = appLoadService.WebsiteList;
        ...
        var bgModule = {
            ...
            changelastActiveTime: function changelastActiveTime(hours) {
                var now = moment();
                bgModule.lastActiveSince = now.subtract(hours, 'h');
            },
            updateTotalVisits: function updateTotalVisits(list) {
            ...
            checkInactiveDays: function checkInactiveDays(lastActive) {
                var inactiveDays = 0;
            ...
            addEmptyDays: function addEmptyDays(days) {
                bgModule.savePastDay();
                while (days > 0) {
            ...
            savePastDay: function savePastDay() {
                bgModule.updateTotalVisits(bgModule.websiteList);
                var pastDay = {
            ...
            cleanDaysToEqualSeven: function cleanDaysToEqualSeven(pastDays) {
                if (pastDays.length > 6) {
                    bgModule.pastDays = pastDays.slice(0, 6);
                }
            },
            saveEmptyDay: function saveEmptyDay() {
                var pastDay = {
                    "websiteList": [],
                    "totalVisits": 0
                };
            ...
            getResetTime: function getResetTime(lastActive) {
                var timeNow = moment();
            ...
            setDaylyTimer: function setDaylyTimer() {
            ...
            updateDeactivationTime: function updateDeactivationTime(tabURL) {
            ...
            tabUpdatedAndActive: function tabUpdatedAndActive(newUrl, favIcon) {
                //prevent from empty entry needs refactor leter
        ...
        var Data = function () {
            function Data(storageName, list) {
            ...
            _createClass(Data, [{
                ...
                value: function save(list) {
                    ...
                    chrome.storage.local.set(_defineProperty({}, this.storageName, list));
        ...
        var PastDaysList = function (_Data) {
            _inherits(PastDaysList, _Data);

            function PastDaysList(storageName, pastDays) {
                _classCallCheck(this, PastDaysList);

                var _this = _possibleConstructorReturn(this, (PastDaysList.__proto__ || Object.getPrototypeOf(PastDaysList)).call(this, storageName, pastDays));

                _this.pastDays = pastDays;
                return _this;
            }

            _createClass(PastDaysList, [{
                key: "getList",
                value: async function getList() {
                    var result = await _get(PastDaysList.prototype.__proto__ || Object.getPrototypeOf(PastDaysList.prototype), "get", this).call(this);
                    this.pastDays = result.pastDays;
                }
            }, {
                key: "addToList",
                value: function addToList(day) {
                    this.blacklist.push(day);
                    _get(PastDaysList.prototype.__proto__ || Object.getPrototypeOf(PastDaysList.prototype), "save", this).call(this, this.pastDays);
                    console.log("Past day was added to past days list...");
                }
            }, {
                key: "removeFromList",
                value: function removeFromList(day) {
                    var index = this.pastDays.indexOf(day);
        ...
        module.exports = {
            ...
            search: function search(websiteName, list) {
            ...
            sortWebsiteList: function sortWebsiteList(list) {
        ...
        var WebsiteBlackList = function (_Data2) {
            _inherits(WebsiteBlackList, _Data2);

            function WebsiteBlackList(storageName, blacklist) {
                _classCallCheck(this, WebsiteBlackList);

                var _this2 = _possibleConstructorReturn(this, (WebsiteBlackList.__proto__ || Object.getPrototypeOf(WebsiteBlackList)).call(this, storageName, blacklist));

                _this2.blacklist = blacklist;
                return _this2;
            }

            _createClass(WebsiteBlackList, [{
                key: "getList",
                value: async function getList() {
                    var result = await _get(WebsiteBlackList.prototype.__proto__ || Object.getPrototypeOf(WebsiteBlackList.prototype), "get", this).call(this);
                    this.blacklist = result.blacklist;
                }
            }, {
                key: "addToList",
                value: function addToList(websiteName) {
                    this.blacklist.push(websiteName);
                    _get(WebsiteBlackList.prototype.__proto__ || Object.getPrototypeOf(WebsiteBlackList.prototype), "save", this).call(this, this.blacklist);
                    console.log(websiteName + " was added to blacklist...");
                }
            }, {
                key: "removeFromList",
                value: function removeFromList(websiteName) {
                    var index = this.blacklist.indexOf(websiteName);
                ...
                key: "checkIfExistInList",
                value: function checkIfExistInList(websiteName) {
        ...
        var WebsiteList = function (_Data3) {
            _inherits(WebsiteList, _Data3);

            function WebsiteList(storageName, websiteList) {
                _classCallCheck(this, WebsiteList);

                var _this3 = _possibleConstructorReturn(this, (WebsiteList.__proto__ || Object.getPrototypeOf(WebsiteList)).call(this, storageName, websiteList));

                _this3.websiteList = websiteList;
                return _this3;
            }
            ...
            _createClass(WebsiteList, [{
                key: "getList",
                value: async function getList() {
                    var result = await _get(WebsiteList.prototype.__proto__ || Object.getPrototypeOf(WebsiteList.prototype), "get", this).call(this);
                    this.websiteList = result.websiteList;
                }
            }, {
                key: "addToList",
                value: function addToList(website) {
                    this.websiteList.push(website);
                    _get(WebsiteList.prototype.__proto__ || Object.getPrototypeOf(WebsiteList.prototype), "save", this).call(this, this.websiteList);
                    console.log(website.websiteName + " was added to webiste list...");
                }
            }, {
                key: "removeFromList",
                value: function removeFromList(website) {
                    //TODO
                }
            }, {
                key: "resetList",
